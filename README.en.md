...
2.  **Download the script:**
    ```bash
    wget https://raw.githubusercontent.com/bivlked/amneziawg-installer/v5.15.0/install_amneziawg_en.sh
    # or: curl -fLo install_amneziawg_en.sh https://raw.githubusercontent.com/bivlked/amneziawg-installer/v5.15.0/install_amneziawg_en.sh
    ```
...
4.  **Run with `sudo`:**
    ...
    *(You can also pass command-line parameters, see `sudo bash ./install_amneziawg_en.sh --help` or [ADVANCED.en.md#install-cli-adv](ADVANCED.en.md#install-cli-adv))*
    ...
    > ```bash
    > wget https://raw.githubusercontent.com/bivlked/amneziawg-installer/v5.15.0/install_amneziawg.sh
